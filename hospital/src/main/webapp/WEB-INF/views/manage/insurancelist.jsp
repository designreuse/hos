...
<div class="wrapper col-sm-10 col-sm-push-1" style="background-color: transparent;">
    <section class="content" id="content">
        <div class="box box-default">
            ...
            <div class="box-body">
                <button class="btn btn-primary pull-right" type="button" id="addnew">新增医保</button>
                <table class="table table-responsive table-striped table-bordered">
                    ...
                    <tbody>
                    <c:forEach items="${insurances}" var="insurance" varStatus="SS">
                        <tr>
                            <td>${SS.count}</td>
